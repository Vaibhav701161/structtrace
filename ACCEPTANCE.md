...
| Recorded workflow scale | Clean commit `3cb2121` completed the deterministic 10,000-case release-binary run in 148.96 s at 326,208 KiB peak RSS and complete replay in 2.27 s at 287,744 KiB; exact inputs, commands, artifact size, and digests are in `benchmarks/recorded-output-10000/result.json`, while the 100,000-case hard ceiling remains explicitly unmeasured |
